...
/** An expression to invoke a static method that uses tail call optimization, and optionally
 * will make a recursive call via a local jump if called from the tail position and
 * localTailCallsToLoops is true.
 */
public class CallTailCallStaticMethod extends Expression {
     ...
     */
    public CallTailCallStaticMethod(String className, String name, Type[] parameterTypes, Type returnType,
     ...
     * @param arguments The method argument values
     */
    public CallTailCallStaticMethod(String name, Type[] parameterTypes, Type returnType,
                                    Expression[] arguments) {
        super(null, 0);
        this.className = null;
        this.name = name;
