...
import org.jfuncmachine.jfuncmachine.compiler.model.expr.conv.*;
import org.jfuncmachine.jfuncmachine.compiler.model.expr.javainterop.*;
...
public class TestJavaInterop {
    ...
    public void testCallSpecial(String generatorType, ClassGenerator generator) {
        ...
        MethodDef callPrivateMethod = new MethodDef("callPrivateMethod", Access.PUBLIC,
                new Field[] { new Field("x", SimpleTypes.STRING)},
                SimpleTypes.STRING,
                new CallJavaSpecialMethod("org.jfuncmachine.jfuncmachine.test.TestJava",
                        "privateMethod", SimpleTypes.STRING,
                        new GetValue("this",
                                new ObjectType("org.jfuncmachine.jfuncmachine.test.TestJava")),
        ...
        ClassDef classDef = new ClassDef("org.jfuncmachine.jfuncmachine.test", "TestJava",
